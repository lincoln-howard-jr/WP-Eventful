 ...
 * Plugin URI:        https://github.com/lincoln-howard-jr/WP-Eventful
 ...
 */
function deactivate_eventful() {
	require_once plugin_dir_path( __FILE__ ) . 'includes/class-eventful-deactivator.php';
	Eventful_Deactivator::deactivate();
}

register_activation_hook( __FILE__, 'activate_eventful' );
register_deactivation_hook( __FILE__, 'deactivate_eventful' );
